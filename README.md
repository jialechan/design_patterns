...
###结构型模式：
[适配器模式(Adapter)](https://github.com/jialechan/design_patterns/blob/master/%E9%80%82%E9%85%8D%E5%99%A8%E6%A8%A1%E5%BC%8F.md)、装饰者模式(Decorator)、代理模式(Proxy)、外观模式(Facade)、桥接模式(Bridge)、组合模式(Composite)、享元模式(Flyweight)
###行为型模式：
